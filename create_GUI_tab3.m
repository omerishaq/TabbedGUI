...
% ui_text = uicontrol(tab3, 'Style', 'text', 'String', 'Select signals for display','Position', [50 position(4)-170 settings.active.popup_lengthX settings.active.popup_lengthY],'HorizontalAlignment','left');
% ui_popup = uicontrol(tab3, 'Style', 'popup', 'String', {'   ','All signals','Only annotated spots'}, 'Position', [270 position(4)-170 settings.active.popup_lengthX settings.active.popup_lengthY],'HorizontalAlignment','left');
% view.tab3.popup_mode = ui_popup;
% 
% % code for adding the drop down for specifying the foreground-background threshold.
% ui_text = uicontrol(tab3, 'Style', 'text', 'String', 'Select foreground threshold (%)','Position', [50 position(4)-230 settings.active.popup_lengthX+50 settings.active.popup_lengthY],'HorizontalAlignment','left');
% ui_popup = uicontrol(tab3, 'Style', 'popup', 'String', {'   ','0.5','0.6','0.7','0.8'}, 'Position', [270 position(4)-230 settings.active.popup_lengthX settings.active.popup_lengthY],'HorizontalAlignment','left','Callback', @update_Threshold);
% view.tab3.popup_threshold = ui_popup;
% 
% ui_text = uicontrol(tab3, 'Style', 'radiobutton', 'String', 'Link displays','Position', [270 position(4)-260 settings.active.popup_lengthX settings.active.popup_lengthY],'HorizontalAlignment','right','Callback', @link_Displays);
...
% 
% set(view.tab3.popup_threshold,'Value',3);
% set(view.tab3.popup_mode,'Value',3);
